...
<template>
  <div class="dropdown">
    <label tabindex="0" class="flex items-center">
      <div class="relative mr-[13px] cursor-pointer">
        <img v-lazy="chainStore.logo" class="w-[40px] h-[40px] rounded-full" />
      ...
      <div class="flex-1 w-0">
        ...
        <div class="text-xs text-white whitespace-nowrap hidden md:!block">
